...
const stores = [
  {
    ...
    quote: "MTechnology showed us how to get started, what to do and how to do it.",
    name: "Jeremy Clarkson",
  },
  {
    image: "/images/shop-2.jpeg",
    quote:
      "We had no idea how to get started, but MTechnology showed us the way. We were able to create something amazing.",
    name: "Richard Hammond",
  },
  {
    image: "/images/s-2.webp",
    quote:
      "The team at MTechnology is extraordinary. They helped us create a stunning store that we're proud of.",
    name: "James May",
  }
];
    ...
    <section className=" mt-10 md:py-10 bg-[#f6f5f4] w-full rounded-3xl">
      <div className=" p-4 mx-auto relative z-10 w-full">
        ...
        <p className="mt-4 text-lg font-normal text-neutral-800 max-w-lg text-center mx-auto">
          We create stunning Shopify stores that are designed to prosper.
        </p>
        <div className="md:flex items-center justify-center px-10">
          {stores.map((store, index) => (
            <div key={index} className="flex flex-col items-center justify-center mt-10 md:w-2/3 mx-auto">
              <div className="flex flex-col items-center justify-center">
                <Image src={store.image} alt="shopify store" width={400} height={400} className="rounded-lg mx-auto"/>
