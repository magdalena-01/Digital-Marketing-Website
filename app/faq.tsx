    ...
    return ( 
        <div className=" mt-10 md:py-10 bg-[#f6f5f4] w-full rounded-3xl">
          <div className=" p-10 md:p-4 md:px-20">
            <div className="text-3xl md:text-7xl font-bold text-black mb-2">
              Have any questions?
            </div>
            ...
            <AccordionItem value="item-1">
              <AccordionTrigger>What is MTechnology ?</AccordionTrigger>
              <AccordionContent>
              MTechnology is a full fledge marketing agency that specializes in branding, web design and digital marketing.
              </AccordionContent>
            </AccordionItem>
