...
const FormSchema = z.object({
  ...
  help: z.enum([
    "Evaluate MTechnology for my company",
    "Learn More",
    "Get a Quote",
    "Other",
  ]),
...
type FormValues = {
  ...
  job_title: string;
  company_name: string;
  help: "Evaluate MTechnology for my company" | "Learn More" | "Get a Quote" | "Other";
  services:
    | "Mobile App Develoment"
    | "Social Media Marketing"
    | "UI/UX Design"
      ...
      <div className="md:flex items-start justify-center md:py-20 px-6">
        <div>
          ...
          <div className="py-4 text-gray-300">
            Let&apos;s talk about how MTechnology can help your team work better.
          </div>
          <div className="bg-[#f6f5f4] md:w-4/5 space-y-6 p-4 rounded-2xl my-4 hidden md:flex md:flex-col">
            <div className="flex gap-4 border-b">
              <div className="font-normal pb-4">
                One flexible agency for your entire company to share knowledge, deliver projects and collaborate.
              </div>
            </div>
            <div className="flex gap-4 border-b">
              <div className="font-normal pb-4">
                Enterprise features to safely manage user access and security.
              </div>
            </div>
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 h-full border rounded-3xl p-10 md:w-1/3">
              ...
              <div className="flex gap-4 items-center">
                ...
                <div className="text-xs font-light md:w-3/4 mb-1 bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400">
                  I agree to MTechnology&apos;s sending marketing communications related to MTechnology
                </div>
              </div>
              <div className="flex items-center gap-4">
                <Button type="submit" className="text-sm font-light" disabled={loading} onClick={() => form.handleSubmit(onSubmit)}>
                  Submit
                </Button>
              </div>
            </form>
