...
const Navbar = ({ scrollToWebsiteDesign, scrollToGraphicDesign, scrollToShopifyStores, scrollToBrands, scrollToServices }: NavbarProps) => {
  ...
  return (
      <div>
         <div className="p-6 md:p-10 flex items-center justify-between z-50">
            ...
            <div className="cursor-pointer hidden md:flex space-x-10 text-slate-300 text-center items-center bg-clip-text
                            text-transparent bg-gradient-to-b from-neutral-50 to bg-neutral-400 bg-opacity-50">
            ...
            <div className="hidden md:flex">
               <Link href="/contact" className="inline-flex h-12 animate-shimmer items-center justify-center rounded-md
