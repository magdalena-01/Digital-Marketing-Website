...
export function CardPattern({ mouseX, mouseY, randomString } : any) {
  ...
  return (
    <div className="pointer-events-none">
      ...
      <motion.div className="absolute inset-0 rounded-2xl bg-gradient-to-r from-green-500 to-blue-700
                             opacity-0  group-hover/card:opacity-100 backdrop-blur-xl transition duration-500"
                  style={style}
      />
...
export const Icon = ({ className, ...rest }: any) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" iewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className={className} {...rest}>
